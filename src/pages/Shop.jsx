      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 font-body">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-9 space-y-6">
            ...
            {/* Top Toolbar */}
            <div className="glass-panel p-4.5 rounded-2xl border border-emerald-500/5 flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <select 
                  ...
                  className="bg-emerald-500/5 border border-emerald-500/10 rounded-xl px-4 py-2.5 text-xs text-emerald-950 font-bold focus:outline-none focus:border-emerald-500 transition cursor-pointer"
                >
